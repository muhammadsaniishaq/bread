                ...
                <form onSubmit={handleSave} className="grid md:grid-cols-[200px_1fr] gap-8 md:gap-10 relative z-10">
                  ...
                  <div className="flex flex-col justify-center gap-6">
                     <div className="grid gap-6 sm:grid-cols-2">
                       ...
                       <div className="flex flex-col gap-2">
                          <label className="text-[11px] font-black text-secondary uppercase tracking-widest pl-2">Retail Price (Γéª) <span className="text-amber-500">*</span></label>
                          <div className="relative">
                            <span className="absolute left-6 top-1/2 -translate-y-1/2 text-secondary font-black">Γéª</span>
                            <input 
                              type="number" 
                 ...
                 <div className="px-2 pb-3 flex flex-col flex-grow">
                   ...
                   <div className="mt-auto">
                     <div className="font-black text-xl sm:text-2xl text-primary tracking-tighter">
                       <span className="text-[12px] sm:text-[14px] font-bold text-secondary mr-0.5 opacity-60">Γéª</span>
