          ...
          >
            {appSettings.logo ? (
              <img 
                ...
                className="w-28 h-28 object-contain mb-8 shadow-2xl rounded-3xl"
              />
            ) : (
              <div className="w-28 h-28 bg-gradient-to-br from-primary to-indigo-600 rounded-3xl flex items-center justify-center text-white text-5xl font-extrabold mb-8 shadow-2xl">
