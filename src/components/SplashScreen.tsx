          ...
          >
            {appSettings.logo ? (
              <img 
                ...
                className="w-40 h-40 object-contain mb-8 shadow-2xl rounded-3xl"
              />
            ) : (
              <div className="w-40 h-40 bg-gradient-to-br from-primary to-indigo-600 rounded-3xl flex items-center justify-center text-white text-6xl font-extrabold mb-8 shadow-2xl">
